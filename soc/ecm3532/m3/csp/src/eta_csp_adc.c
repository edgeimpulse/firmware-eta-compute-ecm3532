...
EtaCspAdcInit(uint32_t ui32ClkDiv, uint8_t ui8SampleTimeUs,
              tAdcGrabDelay iGrabDelay, bit_t iDspDmaEn, bit_t iPeriodicEn,
              bit_t iIntEn)
{
 ...
 ******************************************************************************/
void
EtaCspAdcFifoInit(tAdcFifoIntLevel iIntLevel, bit_t iClear, bit_t iIntEn,
                  bit_t iFifoEn)
{
                      ...
                      uint32_t *pui32NumRead)
{
    ...
    *(volatile uint32_t *)(REG_ADC_SFIFO_ADDR | 0x400000);
    ...
    //
    REG_GPIO_DEBUG0_READ_ONLY.V = REG_ADC_INT_STAT.V;
...
/***************************************************************************//**
 *
 *  EtaCspAdcSampleDataRead - Read the sample data.
 *
...
{
//FIXME    REG_S1(ADC_CNTRL, PERIODIC);
