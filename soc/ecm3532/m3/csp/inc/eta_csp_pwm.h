...
extern tEtaStatus EtaCspPwmPeriodRegSet(tPwmModule iModule,
                                        uint32_t ui32PeriodCnt, bit_t iWait);
...
extern tEtaStatus EtaCspPwmPulseEndRegSet(tPwmModule iModule,
                                          uint32_t ui32PulseEndCnt, bit_t iWait);
...
//
extern void EtaCspPwmMultiStart(bit_t iPwm0, bit_t iPwm1,
                                bit_t iPwm2, bit_t iPwm3);

//
// Stop multiple PWMs simultaneously.
//
extern void EtaCspPwmMultiStopImmediate(bit_t iPwm0, bit_t iPwm1,
                                        bit_t iPwm2, bit_t iPwm3);

//
// Set the PWM idle drive.
//
extern void EtaCspPwmIdleDriveSet(tPwmModule iModule, bit_t iIdleDrive);
...
//
extern void EtaCspPwmCfgMuxChanSet(tPwmChanMux iChan, bit_t iSync,
                                   bit_t iDfltDrive);
