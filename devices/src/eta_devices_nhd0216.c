...
/***************************************************************************//**
 * @addtogroup etadevices-nhd0216 NHD0216 2 Row OLED Display
 * @ingroup etadevices
 * @{
 ******************************************************************************/
...
EtaDevicesNhd0216CommandSend(char cCmd)
{
    ...
    switch(g_sNhd0216Cfg.iMode)
    {
        ...
        {
            pui8Package[0] = g_sNhd0216Cfg.ui8I2cAddress;
            pui8Package[1] = 0x00;
            pui8Package[2] = cCmd;

            _Nhd0216WriteI2c(pui8Package, 3);
            break;
        }
    }
}
...
EtaDevicesNhd0216DataRead(uint8_t ui8Data)
{
    ...
    switch(g_sNhd0216Cfg.iMode)
    {
        ...
        case eNhd0216ModeI2c:
        {
            pui8Package[0] = 0xFE;          /* write the
                                               EtaDevicesNhd0216DataSend */
            pui8Package[1] = ((ui8Data & 0x01) << 7) | ((ui8Data & 0x02) << 5) |
                             ((ui8Data & 0x04) << 3) |
                             ((ui8Data & 0x8) << 1);
            pui8Package[2] = ((ui8Data & 0x10) << 3) | ((ui8Data & 0x20) << 1) |
            ...
            _Nhd0216ReadI2c(&pui8Package[0], 1, &ui8Rev, 1);
