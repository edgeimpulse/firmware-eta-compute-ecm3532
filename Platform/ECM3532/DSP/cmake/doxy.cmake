    set (DOXYGEN_PROJECT_NAME "TENSAI\" \"Flow\" \"DSP\" \"NN\" \"Kernel\" \"API")
    set(DOXYGEN_PROJECT_NUMBER "${PKG_NAME}_${VERSION}")
    set( DOXYGEN_OUTPUT_DIRECTORY "${CMAKE_CURRENT_LIST_DIR}/../../../../Docs/API/doxy_dsp")

    set (DOXYGEN_INPUT "index.md ../kernel/inc")
    ...
    set (DOXYGEN_HTML_EXTRA_STYLESHEET ${CMAKE_CURRENT_LIST_DIR}/../../M3/cmake/resources/css/custom.css)
    set (DOXYGEN_PROJECT_LOGO ${CMAKE_CURRENT_LIST_DIR}/../../M3/cmake/resources/etacompute-logo_large.png)
    set(DOXYGEN_HTML_HEADER ${CMAKE_CURRENT_LIST_DIR}/../../M3/cmake/resources/header.html)
    set(DOXYGEN_HTML_FOOTER ${CMAKE_CURRENT_LIST_DIR}/../../M3/cmake/resources/footer.html)
