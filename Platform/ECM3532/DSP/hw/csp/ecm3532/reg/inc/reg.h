/*
 * @file   reg.h
 * @author David Weber <david@embeddedtoolbox.com>
 * @date   02/07/2008
 *
 * @brief reg module implementation
 *
 * Copyright (C) 2008 - 2018 David Weber
 *
...
// DSP specific types
//#define uint64_t unsigned long long int unsupported
#define uint32_t unsigned long int
#define uint16_t unsigned int
#define uint8_t  unsigned char

//#define int64_t signed long long int unsupported
...
//------------------------------------------------------------------------------
#define FV1(r,f,v)                                                                (((uint16_t)v) << BP_##r##_##f)
