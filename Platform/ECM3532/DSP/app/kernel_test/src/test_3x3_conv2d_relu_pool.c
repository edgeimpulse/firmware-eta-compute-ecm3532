...
//#include "common.h"
#include "test_3x3_conv_relu_pool_1.h"
...
void  test_conv_relu_avgpool_3X3()
{
  ...
  for(k1 = 0; k1 < 100; k1++){
    eta_convolve_CHW_q7_ker3x3_stride1_pad0_relu_avgPool_2x2_stride2_pad0_dsp(x, W_IN, H_IN, CH_IN, w, NUM_KER, bias, bias_shift, out_shift,  output_activation_min, output_activation_max, tmp_buffer, z);
