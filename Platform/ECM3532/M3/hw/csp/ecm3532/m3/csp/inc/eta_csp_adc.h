...
//
// This fence will compile inline and do only one byte reads from the adc block.
//
#define EtaCspAdcFenceFast() \
...
extern tEtaStatus EtaCspAdcInit(uint32_t ui32ClkDiv, uint8_t ui8SampleTimeUs,
                                tAdcGrabDelay iGrabDelay, bool iDspDmaEn,
                                bool iPeriodicEn, bool iIntEn);

//
// ADC FIFO
//
extern void EtaCspAdcFifoInit(tAdcFifoIntLevel iIntLevel, bool iClear,
                              bool iIntEn, bool iFifoEn);
...
extern void EtaCspAdcFifoIntClear(void);
...
extern tEtaStatus EtaCspAdcSampleDataReadWithOflow(uint16_t *pui16Read);
