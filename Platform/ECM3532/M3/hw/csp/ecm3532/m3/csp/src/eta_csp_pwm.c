...
EtaCspPwmDutyCycleSet(tPwmModule iModule, uint32_t ui32Period,
                      uint32_t ui32Width, uint32_t ui32Shift,
                      tPwmCfgReg sPwmCfgReg, bool iWait)
{
    tEtaStatus iStatus = eEtaSuccess;
 ...
 ******************************************************************************/
tEtaStatus
EtaCspPwmCmdFifoWrite(tPwmModule iModule, tPwmReg iReg, bool iWait,
                      uint32_t ui32Data)
{
    tEtaStatus iStatus = eEtaSuccess;
 ...
 ******************************************************************************/
tEtaStatus
EtaCspPwmCfgRegSet(tPwmModule iModule, tPwmCfgReg sPwmCfgReg, bool iWait)
{
...
EtaCspPwmPulseStartRegSet(tPwmModule iModule,
                          uint32_t ui32PulseStartCnt, bool iWait)
{
                    ...
                    tPwmMode iMode3)
{
    ...
    iSet[0] = (bool)(iMode0 != ePwmModeNone);
    iSet[1] = (bool)(iMode1 != ePwmModeNone);
    iSet[2] = (bool)(iMode2 != ePwmModeNone);
    iSet[3] = (bool)(iMode3 != ePwmModeNone);
 ...
 ******************************************************************************/
void
EtaCspPwmMultiStart(bool iPwm0, bool iPwm1, bool iPwm2, bool iPwm3)
{
 ...
 ******************************************************************************/
void
EtaCspPwmMultiStopImmediate(bool iPwm0, bool iPwm1, bool iPwm2, bool iPwm3)
{
    tPwmMode iMode[4] = { ePwmModeNone, ePwmModeNone,
                          ePwmModeNone, ePwmModeNone };
 ...
 ******************************************************************************/
void
EtaCspPwmIdleDriveSet(tPwmModule iModule, bool iIdleDrive)
{
    switch(iModule)
    {
        case ePwmModule0:
 ...
 ******************************************************************************/
void
EtaCspPwmCfgMuxChanSet(tPwmChanMux iChan, bool iSync, bool iDfltDrive)
{
    switch(iChan)
    {
