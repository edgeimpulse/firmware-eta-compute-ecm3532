...
//
// Return the set of Force bits that are turned on.
//
extern uint32_t EtaCspPwrForceGet(void);
...
// Return the set of Force bits that are turned on.
//
extern uint32_t EtaCspPwrOnGet(void);
...
//
extern bool EtaCspPwrGpioFrozenGet(void);

//
// EtaCspPwrGpioFrozenClear - turn off the GPIO FROZEN.
//
extern void EtaCspPwrGpioFrozenClear(void);
