#ifndef EI_ETA_FS_COMMANDS_H
#define EI_ETA_FS_COMMANDS_H
...
typedef enum
{
	ETA_FS_CMD_OK = 0,						/**!< All is well				 */
	ETA_FS_CMD_NOT_INIT,					/**!< FS is not initialised		 */
	ETA_FS_CMD_READ_ERROR,					/**!< Error occured during read  */
	ETA_FS_CMD_WRITE_ERROR,					/**!< Error occured during write */
	ETA_FS_CMD_ERASE_ERROR,					/**!< Erase error occured		 */
	ETA_FS_CMD_NULL_POINTER,				/**!< Null pointer parsed		 */
