...
uint32_t SpiFlashReadId(tSpiNum iNum, tSpiChipSel spiChipSel);

int SpiFlashWriteBuffer(tSpiNum iNum, tSpiChipSel spiChipSel, uint8_t *data, uint16_t data_size);
